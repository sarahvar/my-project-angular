  ...
  jinxBio: Jinx[] = [
    ...
    },
    {
      ...
      details: [
        ...
        "Jinx incarne une âme tourmentée, partagée entre son besoin d'amour et son incapacité à pardonner, ce qui alimente son comportement chaotique et destructeur.",
        "Elle représente un cas complexe de trouble borderline, avec des symptômes tels que : une peur intense de l'abandon, des relations instables et passionnelles, une impulsivité marquée, une instabilité émotionnelle, un sentiment d'identité fragile et une tendance à l'autosabotage émotionnel.",
